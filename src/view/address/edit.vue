<template>
    ...
    <div>
        ...
        <ul>
            ...
            <li>
                ...
                <div class="addAddress" @click="choseAdd()">
                    <input type="text" class="txtmangth" disabled="disabled" v-model="userAddress">
                </div>
                <!-- 收货地址三级联动选项 start-->
        ...
        <button @add="onAdd" class="btn">保存</button>
    </div>
...
<style>
    *{margin: 0;padding: 0;}
    ...
    .determine{display: inline-block;
        width: .75rem;
        text-align: center;
        float: right;
        height: .82rem;
    ...
    ul li input{
        ...
        border-radius: .2rem;
        box-shadow: -0.05rem 0.05rem 0.1rem -0.04rem #999, 0.05rem 0.05rem 0.1rem -0.04rem #999;
    }
    .btn{
        position:fixed;
        width: 90%;
